...
from utils.datasets import create_dataloader, create_dataloader_custom
from utils.general import coco80_to_coco91_class, check_dataset, check_file, check_img_size, check_requirements, \
    box_iou, non_max_suppression, scale_coords, xyxy2xywh, xywh2xyxy, set_logging, increment_path, colorstr, non_max_suppression_np
from utils.metrics import ap_per_class, ConfusionMatrix
from utils.plots import plot_images, output_to_target, plot_study_txt

from utils.torch_utils import select_device, time_synchronized, TracedModel, time_sync

from utils.calibrator import Yolov7EntropyCalibrator
...
def test(data,
    ...
    if training:  # called by train.py
        ...
        set_logging()
        device = select_device(set_device, batch_size=batch_size)
        ...
        # int8 mode 
            ...
            calib = Yolov7EntropyCalibrator(calib_dataset_path, calib_cache_path, profile_shape)
    ...
    if not training:
        ...
        dataloader = create_dataloader_custom(data[task], imgsz, batch_size, 32, opt, pad=0.5, rect=True,
                                       prefix=colorstr(f'{task}: '), resize=resize)[0]
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        dt[0] += t1 - t0
        trt_outputs, dt1 = common.do_inference_v2(context, bindings, input, output, stream)  # inference and training outputs
        dt[1] += dt1
        t3 = time_sync()
    ...
    # Print speeds
    if not training:
        print('Speed: inference {} ms NMS {} ms total {} ms per 1 image'.format(dt[1] / seen * 1E3, dt[1] / seen * 1E3, (dt[0] + dt[1]) / seen * 1E3))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='../runs/yolov7_val_detect_trt', help='save to project/name')
